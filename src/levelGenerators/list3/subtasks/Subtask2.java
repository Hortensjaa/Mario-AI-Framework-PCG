...
public class Subtask2 extends MuPlusLambdaEvolution {
    @Override
    ...
    public static final Weights WEIGHTS = new Weights(
            ...
            Map.ofEntries(
                    ...
                    // ------------ decorators ------------
                    entry(HeuristicComponent.ENEMY_GAP_DISTANCE_BONUS, 5f),
            ...
            Map.of(
                    ...
                    SimulationComponent.JUMPS, 0.05f,
                    SimulationComponent.COINS, 0.01f,
