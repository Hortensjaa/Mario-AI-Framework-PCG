...
public final class Weights {
    public static float TASK1_HEURISTIC_UPPER_BOUND = 25f;
    public float TASK1_SIMULATION_UPPER_BOUND = 100f;
    ...
    public static final Map<HeuristicComponent, Float> TASK1_HEURISTIC_WEIGHTS = Map.ofEntries(
            ...
            entry(HeuristicComponent.GAPS_NUMBER, -1f),
            entry(HeuristicComponent.ENEMY_GROUPS, -5f),
            entry(HeuristicComponent.MONO_TERRAIN, -5f),
            entry(HeuristicComponent.MONO_DECOR, -10f),
            entry(HeuristicComponent.ENEMY_FIRST, -10f),
